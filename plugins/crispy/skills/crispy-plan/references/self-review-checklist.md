...
Before presenting the plan and phase docs, run this checklist. Detail lives in the **phase docs** (`phases/phase-N.md`), not in `6-plan.md`. Validate each phase doc individually.

**Master plan (`6-plan.md`):**
...
- [ ] No implementation details (file paths, code blocks, function signatures) in `6-plan.md` — those belong in phase docs
- [ ] No checkboxes in `6-plan.md` — progress tracking is done via `manifest.json`
...
- [ ] References section links back to 6-plan.md, 1-intent.md, 3-research.md, 4-design.md
